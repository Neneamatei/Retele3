...
def add_to_history(filename, operation, user):
    """Add an operation to file history"""
    with history_lock:
            ...
            try:
                ...
                # File operations
                    ...
                    if not os.path.exists(old_path):
                        ...
                        add_to_history(new_name, f'renamed from {old_name}', current_user)
                    ...
                    if not os.path.exists(filepath):
                        ...
                        with open(filepath, 'r') as f:
                            content = f.read()
                        add_to_history(filename, 'downloaded', current_user)
                        response = {'status': 'success', 'filename': filename, 'content': content, 'message': f'File {filename} downloaded successfully'}
                    ...
                    if not os.path.exists(filepath):
                        ...
                        with open(filepath, 'w') as f:
                            f.write(new_content)
                        add_to_history(filename, 'edited', current_user)
